...
all_labels=[]
for i in onlyfiles:
    print("Cargando audio de: ", i)
    x , sr = librosa.load(audio_path+i.split(".")[0]+"/"+i, mono=True, duration=30)
...
#CREACIÓN DEL DATAFRAME CON FEATURES EXTRAIDOS DE LOS AUDIOS .WAV
...
features_set.to_csv(dir_proyecto+'genres_feat_extracted_raw.csv')